...
for ite in range(iteration):
    for i in range(m):
        # Set starting point
        route[i, 0] = 2  # initial starting position of every ant '1' i.e city '1'
        # Set ending point
        route[i, -1] = 3  # final ending position of every ant '1' i.e city '1'
        ...
        # Note: In the previous version, the last city was assigned outside the loop, now it's part of the loop
